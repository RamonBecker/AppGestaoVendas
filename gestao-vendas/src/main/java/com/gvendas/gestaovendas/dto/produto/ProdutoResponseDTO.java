...
public class ProdutoResponseDTO {
	...
	public static ProdutoResponseDTO conversaoParaProdutoDTO(Produto produto) {
		return new ProdutoResponseDTO(produto.getCodigo(), produto.getDescricao(), produto.getQuantidade(),
				...
				CategoriaResponseDTO.conversaoParaCategoriaDTO(produto.getCategoria()));
	}
